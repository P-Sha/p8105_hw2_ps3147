...
transit_df = 
  ...
  select(transit_df, Line:ADA, -"Exit Only", -Staffing, -"Staff Hours") %>% 
    janitor::clean_names() %>% 
    mutate(
...
The Transit dataset consists of 1,868 observations and 32 variables, with information on subway entrance and exit locations in New York city.
